...
public interface DB {
	...
	public class OpenHelper extends SQLiteOpenHelper {
		...
		private static final String CREATE_TIMESTAMPS_TABLE = "create table if not exists " + DB.Timestamps.TABLE_NAME + " (" + DB.NAME_ID + " integer primary key, "
				+ Timestamps.NAME_TIMESTAMP_TYPE + " int," + Timestamps.NAME_TIMESTAMP + " long, " + Timestamps.NAME_DAYREF + " long);";

		private static final String CREATE_DAYS_TABLE = "create table if not exists " + Days.TABLE_NAME + " (" + DB.NAME_ID + " integer primary key, " + Days.NAME_DAYREF
				+ " long, " + Days.NAME_HOURS_WORKED + " real, " + Days.NAME_HOURS_TARGET + " real," + Days.NAME_HOLIDAY + " real, " + Days.NAME_HOLIDAY_LEFT + " real, "
				+ Days.NAME_OVERTIME + " real, " + Days.NAME_ERROR + " int, " + Days.NAME_FIXED + " int, " + Days.NAME_LAST_UPDATED + " long, " + Days.NAME_MONTHREF + " long);";

		private static final String CREATE_MONTH_TABLE = "create table if not exists " + Months.TABLE_NAME + " (" + DB.NAME_ID + " integer primary key, " + Months.NAME_MONTHREF
				+ " long, " + Months.NAME_HOURS_WORKED + " real, " + Months.NAME_HOURS_TARGET + " real," + Months.NAME_HOLIDAY + " real, " + Months.NAME_HOLIDAY_LEFT + " real, "
	...
	public interface Days {
		...
		public static final String[] colNames = new String[] { NAME_ID, NAME_DAYREF, NAME_HOURS_WORKED, NAME_HOURS_TARGET, NAME_HOLIDAY, NAME_HOLIDAY_LEFT, NAME_OVERTIME,
				NAME_ERROR, NAME_FIXED, NAME_LAST_UPDATED, NAME_MONTHREF };
		public static final String[] DEFAULT_PROJECTION = colNames;
	...
	public interface Months {
		...
		public static final String[] colNames = new String[] { NAME_ID, NAME_MONTHREF, NAME_HOURS_WORKED, NAME_HOURS_TARGET, NAME_HOLIDAY, NAME_HOLIDAY_LEFT, NAME_OVERTIME,
