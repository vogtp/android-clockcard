...
public class Day {
	...
	public void recalculate(Day previousDay) {
		float hoursWorked = 0;
		// FIXME
		// // calculate for timestamps
		// Cursor c = getTimestamps();
		// while (c.moveToNext()) {
		...
		// hoursWorked += (t2.getTimestamp() - t1.getTimestamp()) /
		// HOURS_IN_MILLIES;
		// } else {
		// setError();
		// }
		...
		// }
		//
		// this.hoursTarget = hoursTargetDefault - overtimeCompensation -
		// holyday * hoursTargetDefault;
		// this.overtime = previousDay.getOvertime() + hoursWorked -
		// hoursTarget;
